...
struct SolveResult {
    ...
    bool round38_pilot_all_initial_lps_complete = false;
    long long round38_pilot_initial_lp_count = 0;
    long long round38_pilot_eligible_cell_count = 0;
    std::string round38_pilot_selected_leaf_id;
    double round38_pilot_selected_lower_bound = 0.0;
    double round38_pilot_selected_gamma_L = 0.0;
    double round38_pilot_selected_gamma_U = 0.0;
    long long round38_pilot_frontier_plateau_size = 0;
    bool round38_pilot_unique_controlling_cell = false;
    bool round38_pilot_next_strict_frontier_available = false;
    double round38_pilot_next_strict_frontier = 0.0;
    std::string round38_pilot_sorted_initial_bounds;
    bool round38_pilot_children_evaluated = false;
    bool round38_pilot_left_child_infeasible = false;
    bool round38_pilot_right_child_infeasible = false;
    double round38_pilot_left_child_bound = 0.0;
    double round38_pilot_right_child_bound = 0.0;
    bool round38_pilot_b_plus_infinite = false;
    double round38_pilot_b_plus = 0.0;
    double round38_pilot_delta_local = 0.0;
    double round38_pilot_hypothetical_global_bound = 0.0;
    double round38_pilot_delta_global = 0.0;
    double round38_pilot_frontier_completion = 0.0;
    bool round38_pilot_completes_next_strict_frontier = false;
    std::string round38_pilot_sorted_post_bounds;
    bool round38_pilot_refinement_performed = false;
    long long round38_pilot_refinement_count = 0;
    long long round38_pilot_rejection_count = 0;
    std::string round38_pilot_decision_reason = "not_evaluated";
