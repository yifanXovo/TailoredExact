...
def main() -> int:
    ...
    final_lines.extend([
        ...
        "- `callback_activity_summary.csv` now reports basic transfer-cutset callback candidates, violations, and cuts. In this package the callback separator was exercised on hard-leaf rows but found no violated transfer-cutset rows.",
