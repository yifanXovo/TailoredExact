...
def synthesize_json(
    *,
    ...
    payload: Dict[str, Any] = {
        ...
        "interval_oracle_model_type": "diagnostic_unknown",
        "interval_oracle_bound_valid": False,
        "interval_oracle_bound_scope": "diagnostic",
        "interval_oracle_objective_sense": "minimize",
        "interval_oracle_has_objective_cutoff_row": False,
        "interval_oracle_has_gamma_interval_rows": False,
        "interval_oracle_solver_best_bound": 0.0,
        "interval_oracle_solver_incumbent": 0.0,
        "interval_oracle_gap_to_cutoff": 0.0,
        "interval_oracle_can_merge_bound": False,
        "oracle_bound_merged_leaves": 0,
        "oracle_bound_closed_leaves": 0,
        "oracle_bound_best_global_lb": lower,
        "oracle_bound_merge_audit_csv_path": "",
...
def build_command(
    ...
    return [
        ...
        "--interval-exact-oracle-mode", "both",
...
def summarize_round(result_dir: Path, rows: Iterable[tuple]) -> None:
    ...
    for name, input_path_text, scope, v, m, time_limit, wall_timeout in rows:
        ...
        summary.append({
            ...
            "oracle_bound_merged_leaves": data.get("oracle_bound_merged_leaves", ""),
            "oracle_bound_closed_leaves": data.get("oracle_bound_closed_leaves", ""),
            "oracle_bound_best_global_lb": data.get("oracle_bound_best_global_lb", ""),
            "oracle_bound_merge_audit_csv_path": data.get("oracle_bound_merge_audit_csv_path", ""),
