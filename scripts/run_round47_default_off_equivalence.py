#!/usr/bin/env python3
"""Run the permitted default-off historical C6 equivalence sentinel."""
...
import round46_common as historical
...
def main() -> int:
    ...
    for mode in ("implicit", "explicit"):
        ...
        common.write_json(run_dir / "command.json", {
            "mode": mode, "round47_mode": "off", "rho": 0.01,
    ...
    common.write_json(common.OUT / "default_off_equivalence.json", {
        "schema": "round47-default-off-equivalence-v1", "passed": passed,
        "instance": INSTANCE, "process_cap_seconds": args.process_cap,
        "executable_sha256": common.sha256(executable),
        "round47_mode": "off", "correctness_sentinel_not_benchmark_row": True,
