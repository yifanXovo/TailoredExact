...
OUT=ROOT/'results/unified_exact_round70';BUILD=ROOT/'build/round70';RAW=OUT/'local_raw'
...
def freeze():
    ...
    assert q['final_ctest_passed_tests']==46 and q['final_binary_sha256']==sha(BUILD/'ExactEBRP.exe')
