# Round84 evidence decision

Evidence review passes. All nine original runs are valid, all frozen audits
...
one whole deadline and no per-instance or resource-slicing selector. R84 adds
validation, not a new algorithm parameter, implementation or novelty claim.

This stage supports continuing the candidate. D6 certifies within3600 while
both current controls remain open; the current K1/P proof deficit is real.
D7 improves P gap47.2512% and retains84.8010% of K1's P advantage, but its
19.1258% final K1 gap loss is material. Its1200s K1 gap loss is severe under
the same frozen rule, while retaining75.3324% of K1's P advantage and beating
P by58.4705%. Both judgments are retained; K1-only loss is not an automatic veto.
U6 repeats the13.5852% P gain and retains88.3722% of current K1 advantage,
with a near final K1 difference and mixed U/L directions.
