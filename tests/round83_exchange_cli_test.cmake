...
set(root "${OUTPUT_ROOT}/round83_exchange_cli_${suffix}")
if(EXISTS "${root}")
...
foreach(arm ENS-C)
  ...
  set(preset research-round83-vds-equal-net-exchange)
  ...
  file(READ "${out}/hga.csv.exchange/result.json" balanced)
  ...
  if(NOT exhausted OR rejected OR deadline OR NOT result MATCHES "Round83 equal-net exchange descent")
    message(FATAL_ERROR "Balanced controller did not complete a verified descent; artifacts=${out}")
  endif()
  foreach(suffix initial final)
    if(NOT EXISTS "${out}/hga.csv.exchange/${suffix}.json")
  ...
  message(STATUS "Round83ExchangeDescentCliTests ${arm}: certificate5/24; Optimize calls=${calls}; artifacts=${out}")
endforeach()
