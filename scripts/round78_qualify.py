...
def main():
    ...
    build=ROOT/'build/round78'/version
    ...
    assert not subprocess.check_output(['git','status','--porcelain','--','src','include','tests','CMakeLists.txt','scripts/round78_qualify.py','scripts/round78_audit_qualification.py'],cwd=ROOT).strip(),'Commit measured source first'
    for stage in ['unified_exact_round72/campaign','unified_exact_round73','unified_exact_round74/campaign','unified_exact_round78/startup']:
