...
def main():
    ...
    manifest=dict(bundles=bundles,source_scope='All18 complete-run raw files and six original compact reference trees; inherited R78 qualification/startup/diagnostic bundles are referenced, not duplicated',
    ...
    resource=dict(new_qualification_calls=0,new_build_calls=0,new_ctests=0,new_native_fixture_calls=0,
        ...
        new_input_generation_seconds=read(OUT/'generation.json')['wall_seconds'],
