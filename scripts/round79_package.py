...
OUT=ROOT/'results/unified_exact_round79'
...
def main():
    ...
    manifest=dict(bundles=bundles,source_scope='All 18 complete-run raw files and six original compact reference trees; inherited R78 qualification/startup/diagnostic bundles are referenced, not duplicated',
