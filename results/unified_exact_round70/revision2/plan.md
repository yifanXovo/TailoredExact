Revision2 pre-performance correction. See ../revision1_failure.json. Six initial micros (two DS configuration failures) remain fully charged and retained. This revision adds six fresh micros and ten reference exports; stage-wide maximum27 performance+12 micro launches and9240 experiment seconds. No performance results were opened, no candidate parameter or evaluation threshold changed.
