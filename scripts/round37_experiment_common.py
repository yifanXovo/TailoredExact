#!/usr/bin/env python3
"""Frozen identities and paired commands for Round 37 geometry experiments."""
...
EXE = ROOT / "build_round37" / "official" / "gurobi" / "ExactEBRP.exe"
SMOKE_MATRIX = OUT / "round37_smoke_matrix.csv"
SMOKE_FREEZE = OUT / "round37_smoke_freeze.json"
