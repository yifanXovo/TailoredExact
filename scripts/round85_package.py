...
def main():
    ...
    manifest=dict(bundles=bundles,
        source_scope='All twenty-one original complete-run trees and seven original compact exports. Exact source/qualification/startup inherited from byte-bound R83 bundles; no executable, license or new qualification.',
