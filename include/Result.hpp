...
struct SolveResult {
    ...
    std::string round48_k1_amf = "off";
    std::string round48_amf_profile_version = "off";
    long long round48_amf_decision_count = 0;
    long long round48_amf_rescue_count = 0;
    long long round48_amf_invalid_profile_fallback_count = 0;
    long long round48_amf_extra_lp_count = 0;
    long long round48_amf_extra_mip_count = 0;
    long long round48_amf_max_eligible_variable_count = 0;
    std::string round48_amf_decision_ledger_path;
    std::string round48_formulation_strength_ledger_path;
    std::string round48_formulation_variable_registry_path;
    std::string round48_model_size_ledger_path;
    std::string round48_certificate_ledger_path;
    std::string round48_artifact_manifest_path;
    std::string round48_completion_marker_path;
    std::string round49_k1_am_rc = "off";
    std::string round49_rc_profile_version = "off";
    long long round49_rc_decision_count = 0;
    long long round49_rc_valid_decision_count = 0;
    long long round49_rc_rescue_count = 0;
    long long round49_rc_invalid_profile_fallback_count = 0;
    long long round49_rc_extra_lp_count = 0;
    long long round49_rc_extra_mip_count = 0;
    long long round49_rc_max_primitive_variable_count = 0;
    std::string round49_rc_decision_ledger_path;
    std::string round49_rc_variable_domain_ledger_path;
    std::string round49_lp_primal_dual_ledger_path;
    std::string round49_model_size_ledger_path;
    std::string round49_certificate_ledger_path;
    std::string round49_artifact_manifest_path;
    std::string round49_completion_marker_path;
    std::string round48_counterfactual_mode = "off";
    std::string round48_counterfactual_interval;
    bool round48_counterfactual_performed = false;
    long long round48_counterfactual_descendant_split_suppression_count = 0;
    ...
    bool round41_static_segmented_attempted = false;
    bool round41_static_segmented_technical_feasible = false;
    bool round41_static_segmented_coverage_valid = false;
    double round41_static_segmented_gamma_lower = 0.0;
    double round41_static_segmented_gamma_upper = 0.0;
    double round41_static_segmented_midpoint = 0.0;
    std::string round41_static_segmented_intervals;
    std::string round41_static_segmented_model_path;
    std::string round41_static_segmented_model_sha256;
    std::string round41_static_segmented_model_scope;
    std::string round41_static_segmented_family_encoding;
    long long round41_static_segment_count = 0;
    long long round41_static_selector_variables = 0;
    long long round41_static_perspective_variables = 0;
    long long round41_static_extended_variables = 0;
    long long round41_static_indicator_rows = 0;
    long long round41_static_linear_rows = 0;
    long long round41_static_model_variables = 0;
    long long round41_static_model_linear_constraints = 0;
    long long round41_static_model_nonzeros = 0;
    long long round41_static_model_binary_variables = 0;
    long long round41_static_model_integer_variables = 0;
    long long round41_static_model_continuous_variables = 0;
    long long round41_static_model_general_constraints = 0;
    bool round41_static_presolved_size_available = false;
    long long round41_static_presolved_rows = 0;
    long long round41_static_presolved_columns = 0;
    long long round41_static_presolved_nonzeros = 0;
    double round41_static_model_build_seconds = 0.0;
    double round41_static_model_read_seconds = 0.0;
    long long round41_static_optimize_count = 0;
    long long round41_static_integer_proof_job_count = 0;
    bool round41_static_one_native_mip_job = false;
    bool round41_static_root_lp_bound_available = false;
    double round41_static_root_lp_bound = 0.0;
    bool round41_static_lp_diagnostics_available = false;
    double round41_static_route_binary_fractionality = 0.0;
    double round41_static_visit_binary_fractionality = 0.0;
    double round41_static_inventory_bit_fractionality = 0.0;
    double round41_static_selector_binary_fractionality = 0.0;
    double round41_static_mccormick_ambiguity = 0.0;
    double round41_static_segmented_mccormick_ambiguity = 0.0;
    double round41_static_solver_runtime_seconds = 0.0;
    double round41_static_solver_work = 0.0;
    double round41_static_solver_nodes = 0.0;
    double round41_static_peak_memory_gb = 0.0;
    std::string round41_static_native_status;
    int round41_static_native_status_code = 0;
    bool round41_static_native_bound_available = false;
    double round41_static_native_bound = 0.0;
    bool round41_static_parameter_roundtrip_valid = false;
    bool round41_static_original_verifier_passed = false;
    bool round41_static_strict_certificate = false;
    std::string round41_static_failure_reason = "not_attempted";
    std::string round42_static_architecture = "off";
    std::string round42_static_solve = "mip";
    bool round42_static_attempted = false;
    bool round42_block_full_global_cover = false;
    bool round42_block_strict_certificate = false;
    double round42_block_union_lower = 0.0;
    double round42_block_union_upper = 0.0;
    std::string round42_block_intervals;
    bool round42_common_row_factoring = false;
    bool round42_hierarchical_selectors = false;
    std::string round42_static_model_identity;
    long long round42_factored_unconditional_rows = 0;
    long long round42_factored_weighted_rhs_rows = 0;
    long long round42_factored_indicator_rows_removed = 0;
    long long round42_hierarchical_selector_variables = 0;
    std::string round42_terminal_sibling_coalescing = "off";
    long long round42_sibling_pairs_considered = 0;
    long long round42_sibling_pairs_coalesced = 0;
    long long round42_sibling_block_optimize_count = 0;
    long long round42_sibling_replaced_leaf_count = 0;
    long long round42_sibling_atomic_coverage_events = 0;
    long long round42_sibling_fallback_events = 0;
    long long round42_sibling_unresolved_union_count = 0;
    std::string round42_sibling_coverage_ledger_path;
