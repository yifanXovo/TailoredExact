...
4a0561e0f8193e3e874c1bd0bfa8bc381fb66f5e. R81/unified_method.md defines the
active algorithm, mathematical scope, parameters and source map. R82 changes
none of these. P-GRB remains the primary official compact/native benchmark;
K1-R is the explicitly defined shared-reliability reference, not a historical
best-variant envelope. No merged default or universal speed claim is proposed.

|Required question|Existing matched evidence|Qualification or remaining check|
|---|---|---|
|Uniform exact architecture|R78 mathematics/qualification; R81 complete method and actual path/Start audits|Numerical certification and analytic validity are separate; no rational checker or runtime dominance theorem. R82 identities and evidence still require final audit.|
|Current small regressions|R79 E7 near P, S12/N12 materially faster; R80 E8 near P and repairs current severe K1 total-time loss; R81 S12 gain reproduces|E7/E8's older large non-startup labels did not reproduce in R66. This is reclassification, not an invented repair. S12/E8 gains are mostly startup.|
|A non-startup small deficit|R69 N12: K1-R/VD-S have the same paid initial witness and nearly equal HGA cost; post-HGA wall about5.462/1.893s. R79 final BDS-C certifies1.391s versus P4.281/K1-R7.438s|The post-HGA subtraction is attribution only; all formal comparisons charge full cost. R69 is earlier VD-S mechanism evidence, not a BDS-C repeat or unseen confirmation. N12's current K1 loss is material, not severe under the frozen absolute rule.|
...
The current candidate's evidence is not a claim that every earlier explored
configuration succeeded: R66 ARC, R67 LOG and R74/R77 startup variants retain
their documented negative D6 or D7 outcomes and are not silently enabled.

R82 supplies six new unadapted draws from familiar recipes, including nonzero
proof-difficult medium/large roles. Citi coordinates and capacities share a
443-station source with earlier selections; inventories, targets and operating
parameters are synthetic. Generation/overlap records and scope_and_nonzero.md
disclose those dependencies. Same-run checkpoints and overlapping geography
