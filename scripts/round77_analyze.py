...
def main():
    ...
    assert sha(ROOT/'results/unified_exact_round77/plan.md')==frozen['plan_sha256']
    ...
    for t in [300,600,900,1200]:
        ...
        for a,b in [('P-GRB','JDS-C'),('P-GRB','K1-R'),('K1-R','JDS-C')]:
            comparisons.append(dict(seconds=t,reference=a,candidate=b,**compare(arms[a],arms[b])))
        p,k,j=arms['P-GRB'],arms['K1-R'],arms['JDS-C']
        fraction=None
