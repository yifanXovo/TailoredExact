...
def write_diagnostic_timeout_json(
    ...
    *,
    ...
    data = {
        ...
        "tailored_bc_variable_s_centering_cuts_added": 0,
        "tailored_bc_variable_s_centering_violations": 0,
        ...
        "tailored_bc_support_duration_quad_cuts_added": 0,
        "tailored_bc_support_duration_quad_candidates": 0,
        "tailored_bc_support_duration_quad_violations": 0,
...
def result_row(name: str, path: Path, meta: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "tailored_bc_variable_s_centering_cuts_added": data.get("tailored_bc_variable_s_centering_cuts_added", ""),
        "tailored_bc_variable_s_centering_violations": data.get("tailored_bc_variable_s_centering_violations", ""),
        ...
        "tailored_bc_support_duration_quad_cuts_added": data.get("tailored_bc_support_duration_quad_cuts_added", ""),
        "tailored_bc_support_duration_quad_candidates": data.get("tailored_bc_support_duration_quad_candidates", ""),
        "tailored_bc_support_duration_quad_violations": data.get("tailored_bc_support_duration_quad_violations", ""),
...
def main() -> int:
    ...
    write_csv(RESULTS / "tailored_bc_vs_static.csv", [
        {
            ...
            "callback_cut_families": "gini_interval_cap,visit_inventory_linking,gini_subset_envelope,low_gini_l1_centering,variable_s_centering,subset_inventory_imbalance,transfer_cutset,support_duration_pair,support_duration_triple,support_duration_quad,support_duration_lifted",
        }
    ])
    ...
    write_csv(RESULTS / "callback_event_summary.csv", [
        {
            ...
            "callback_variable_s_centering_cuts": sum_family("callback_variable_s_centering"),
            ...
            "callback_support_duration_quad_cuts": sum_family("callback_support_duration_quad"),
            "callback_support_duration_lifted_cuts": sum_family("callback_support_duration_lifted"),
            ...
            "callback_variable_s_centering_violations": sum(int_value(row.get("tailored_bc_variable_s_centering_violations")) for row in all_callback_rows),
            ...
            "callback_support_duration_quad_candidates": sum(int_value(row.get("tailored_bc_support_duration_quad_candidates")) for row in all_callback_rows),
    ...
    final_lines.extend([
        ...
        "- `callback_activity_summary.csv` now reports subset-inventory imbalance, basic transfer-cutset, variable-S low-Gini centering, and support-duration callback candidates, violations, and cuts. In this package those separators were exercised on callback rows; subset-inventory candidates are conservative singleton/pair/triple station inventory-envelope rows, and support-duration candidates mean evaluated high-support pair/triple/quad subsets. Lifted support-duration cuts use the strongest safe small-subset cardinality RHS proved by depot-cycle and pickup-only handling lower bounds.",
