...
def main():
    ...
    parser.add_argument('--arms',nargs='+',required=True,choices=['P-GRB','VD-S','DS','K1-R'])
    parser.add_argument('--cap',type=int,required=True,choices=[30,120,300,600])
    ...
    qualification.update(fresh_reproduction_note='Identical qualified bytes; no new build/CTest batch',
        inherited_ctest_tests=47,newly_executed_ctest_tests=0)
