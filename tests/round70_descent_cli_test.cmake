...
set(out "${OUTPUT_ROOT}/round70_cli_${suffix}")
if(EXISTS "${out}")
...
execute_process(COMMAND "${EXACT_EXE}"
  ...
  --method gcap-frontier --algorithm-preset research-round70-vds-descent
...
if(NOT exit_code EQUAL 0)
  message(FATAL_ERROR "Real DS CLI failed: ${exit_code}; artifacts=${out}")
endif()
...
foreach(field strict_certified_original_problem decoded_descent_complete
  ...
  if(NOT value)
    message(FATAL_ERROR "DS CLI did not establish ${field}; artifacts=${out}")
  endif()
endforeach()
...
if(NOT starts)
  message(FATAL_ERROR "DS CLI did not exercise a native Start decision")
endif()
message(STATUS "Round70DescentCliTests: real CLI certificate5/24; Optimize calls=${calls}; artifacts=${out}")
